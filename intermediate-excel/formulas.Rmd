...
What would you put in the pivot table options to answer this question:

Which states have the largest disparity (gap) for those who show signs of mental illness versus those who don’t?
Put the question another way: If you’re an Asian person suffering from mental health issues, in which state are police most likely to shoot you if you confront them?
